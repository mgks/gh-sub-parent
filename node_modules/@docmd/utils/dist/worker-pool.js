...
export class WorkerPool extends EventEmitter {
    ...
    isTerminated = false;
    initialized = false;
    constructor(workerScript, workerData = {}, poolSize = Math.max(1, os.cpus().length - 1)) {
        super();
    ...
    ensureInitialized() {
        if (this.initialized || this.isTerminated)
            return;
    ...
    runTask(taskPayload) {
        return new Promise((resolve, reject) => {
            ...
            const task = { id: taskId, payload: taskPayload };
