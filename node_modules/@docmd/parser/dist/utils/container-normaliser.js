 ...
 * (F2) and is removed.
 */
export const SELF_CLOSING_CONTAINER_NAMES = new Set([
    'button',
    'tag',
    'embed'
]);
 ...
 */
export function normaliseContainers(source, options = {}) {
        ...
        if (cls.kind === 'close') {
            ...
            if (closed.length > 1) {
                recordWarning({
                    ...
                    severity: 'info',
                    path: sourcePath,
                    message: `Closed ${closed.length} containers implicitly (` +
