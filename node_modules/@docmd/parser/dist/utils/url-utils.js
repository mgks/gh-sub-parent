 ...
 */
export function outputPathToSlug(outputPath) {
    if (!outputPath)
        return '/';
 ...
 * @returns e.g. `/guide/`
 */
export function outputPathToPathname(outputPath) {
 ...
 */
export function outputPathToCanonical(outputPath, siteUrl) {
    if (!siteUrl)
        return '';
 ...
 */
export function buildContextualUrl(href, context) {
 ...
 */
export function buildRootRelativeUrl(href, context) {
 ...
 */
export function stripDefaultLocalePrefixFromHtml(html, defaultLocale) {
    if (!defaultLocale)
        return html;
 ...
 */
export function rewriteHtmlLinks(html, context, opts) {
    ...
    html = html.replace(/<(a|img)\s+([^>]*?)\b(href|src)\s*=\s*("([^"]*)"|'([^']*)')([^>]*)>/gi, (full, _tag, _pre, _attr, quoted, dq, sq) => {
 ...
 */
export function computePageUrls(outputPath, siteUrl) {
    return Object.freeze({
 ...
 */
export function buildAbsoluteUrl(base, localePrefix = '', versionPrefix = '', pagePath = '') {
 ...
 *   // → './index.html'
 */
export function buildAbsoluteContextualUrl(base, localePrefix = '', versionPrefix = '', pagePath = '', context) {
 ...
 */
export function normaliseBaseTag(html, isOffline, siteRootAbs) {
