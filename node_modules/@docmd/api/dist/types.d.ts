...
export type Capability = 'markdown' | 'head' | 'body' | 'assets' | 'post-build' | 'actions' | 'events' | 'translations' | 'init' | 'build' | 'dev' | 'template';
/**
...
export interface SourceTools {
    ...
    getBlockAt(file: string, blockRef: [number, number], options?: {
        textOffset?: number;
    }): Promise<BlockInfo>;
...
export interface PluginModule {
    ...
    generateScripts?(config: any, options?: any): {
 ...
 */
export declare const engineRegistry: Map<string, EngineLoader>;
/**
 * Register an engine loader.
 */
export declare function registerEngine(name: string, loader: EngineLoader): void;
/**
 * Built-in task types that the API layer supports.
 * Engines don't define these - the API does.
 */
export type BuiltinTaskType = 'file:discover' | 'file:read' | 'file:readBatch' | 'file:write' | 'file:exists' | 'git:log' | 'git:status' | 'search:index' | 'search:query' | 'exec:script';
/**
 ...
 */
export type TemplateSlot = 'layout' | '404' | 'toc' | 'navigation' | 'footer' | 'menubar' | 'options-menu' | 'project-switcher' | 'version-dropdown' | 'language-switcher' | 'banner' | 'cookie-consent';
/**
