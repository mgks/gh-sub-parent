...
export function validateLinks(docsDir) {
    const errors = [];
            ...
            lines.forEach((lineText, lineIdx) => {
                ...
                while ((match = linkRegex.exec(lineText)) !== null) {
                    ...
                    const stripped = resolvedPath.endsWith('/') && resolvedPath.length > 1
                        ...
                        : resolvedPath;
                    const exists = fs.existsSync(stripped) ||
                        ...
                        const safeSummary = {
                            ...
                            i18n: resolvedConfig.i18n
                                ? {
                                    ...
                                    locales: (resolvedConfig.i18n.locales || []).map((l) => ({ id: l.id, label: l.label, dir: l.dir }))
                                }
                                : null,
                            versions: resolvedConfig.versions
                                ? {
                                    current: resolvedConfig.versions.current,
                                    all: (resolvedConfig.versions.all || []).map((v) => ({ id: v.id, dir: v.dir, label: v.label }))
                                }
                                : null,
