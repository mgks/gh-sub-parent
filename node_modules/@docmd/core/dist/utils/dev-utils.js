 ...
 */
export function formatPathForDisplay(absolutePath, cwd) {
...
export function getDevInfoScript() {
...
export async function serveStatic(req, res, rootDir) {
    ...
    if (req.url === '/__dev/docmd-api.js') {
        try {
            const apiScriptPath = path.resolve(fileURLToPath(import.meta.url), '../../../../ui/assets/js/docmd-api.js');
...
export function openBrowser(url) {
    if (process.env.DOCMD_CONTAINER === 'true')
        return;
